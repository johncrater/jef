...
//			.getInUnit(DUnits.YARD);
	...
	public static final LineSegment WEST_END_ZONE_BACK = new LineSegment(
			new DefaultLocation(FIELD_BORDER_WIDTH, FIELD_BORDER_WIDTH),
			new DefaultLocation(FIELD_BORDER_WIDTH, FIELD_BORDER_WIDTH + FIELD_PLAYABLE_WIDTH));

	public static final LineSegment EAST_END_ZONE_BACK = new LineSegment(
			new DefaultLocation(FIELD_TOTAL_LENGTH - FIELD_BORDER_WIDTH, FIELD_BORDER_WIDTH),
			new DefaultLocation(FIELD_TOTAL_LENGTH - FIELD_BORDER_WIDTH, FIELD_BORDER_WIDTH + FIELD_PLAYABLE_WIDTH));

	public static final double WEST_END_ZONE_BACK_X = FIELD_BORDER_WIDTH;
	public static final double WEST_END_ZONE_X = WEST_END_ZONE_BACK_X + FIELD_END_ZONE_DEPTH;
	public static final double EAST_END_ZONE_X = FIELD_TOTAL_LENGTH - (FIELD_BORDER_WIDTH + FIELD_END_ZONE_DEPTH);
	public static final double EAST_END_ZONE_BACK_X = FIELD_TOTAL_LENGTH - FIELD_BORDER_WIDTH;
